...
impl Agent for DelayedHistoryAgent {
    ...
    fn default_configuration(
        ...
        agentdeck_protocol::runtime::ConversationConfiguration,
        agentdeck_protocol::runtime::ConfigurationError,
    > {
...
async fn router_queries_both_history_sources_concurrently() {
    ...
    let response = tokio::time::timeout(
        ...
        router.handle_history_stdio_compat(HistoryRequest::List {
...
async fn router_codex_read_returns_real_history_when_available() {
    ...
    let r = router_with_both();
    let listed = r
        .handle_history_stdio_compat(HistoryRequest::List {
            request_id: None,
            agent_kind: Some(AgentKind::Codex),
            cwd_filter: None,
            limit: Some(1),
    ...
    let read = r
        .handle_history_stdio_compat(HistoryRequest::Read {
            request_id: None,
