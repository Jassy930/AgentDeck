...
fn copy_ledger(ledger: &RuntimeLedger) -> RuntimeLedger {
    RuntimeLedger {
        ...
        audit_event_logical_bytes: ledger.audit_event_logical_bytes,
        event_stream_count: ledger.event_stream_count,
        event_stream_bytes: ledger.event_stream_bytes,
        catalog_delta_count: ledger.catalog_delta_count,
        catalog_delta_bytes: ledger.catalog_delta_bytes,
        catalog_retention_floor: ledger.catalog_retention_floor.clone(),
        snapshot_count: ledger.snapshot_count,
        snapshot_bytes: ledger.snapshot_bytes,
        publication_stream_count: ledger.publication_stream_count,
        publication_outbox_count: ledger.publication_outbox_count,
        publication_outbox_bytes: ledger.publication_outbox_bytes,
        configuration_count: ledger.configuration_count,
        configuration_sealed_bytes: ledger.configuration_sealed_bytes,
        command_configuration_pin_count: ledger.command_configuration_pin_count,
        metadata_mutation_count: ledger.metadata_mutation_count,
        active_metadata_mutation_count: ledger.active_metadata_mutation_count,
        metadata_mutation_charged_bytes: ledger.metadata_mutation_charged_bytes,
        native_projection_present_count: ledger.native_projection_present_count,
        native_projection_tombstone_count: ledger.native_projection_tombstone_count,
        native_projection_retired_count: ledger.native_projection_retired_count,
        native_projection_physical_count: ledger.native_projection_physical_count,
        native_projection_charged_bytes: ledger.native_projection_charged_bytes,
        native_metadata_effect_fence_count: ledger.native_metadata_effect_fence_count,
        native_metadata_effect_unreleased_count: ledger.native_metadata_effect_unreleased_count,
        native_metadata_effect_released_count: ledger.native_metadata_effect_released_count,
        ...
        remote_pairing_count: ledger.remote_pairing_count,
        remote_pairing_sealed_bytes: ledger.remote_pairing_sealed_bytes,
        remote_pairing_receipt_count: ledger.remote_pairing_receipt_count,
        remote_pairing_receipt_bytes: ledger.remote_pairing_receipt_bytes,
        remote_authorization_count: ledger.remote_authorization_count,
        remote_authorization_preparing_count: ledger.remote_authorization_preparing_count,
        remote_authorization_active_count: ledger.remote_authorization_active_count,
        remote_authorization_revoking_count: ledger.remote_authorization_revoking_count,
        remote_authorization_revoked_count: ledger.remote_authorization_revoked_count,
        remote_authorization_sealed_bytes: ledger.remote_authorization_sealed_bytes,
        remote_key_directory_count: ledger.remote_key_directory_count,
        remote_key_directory_sealed_bytes: ledger.remote_key_directory_sealed_bytes,
        remote_control_outbox_count: ledger.remote_control_outbox_count,
        remote_control_outbox_pending_count: ledger.remote_control_outbox_pending_count,
        remote_control_outbox_acknowledged_count: ledger.remote_control_outbox_acknowledged_count,
        remote_control_outbox_sealed_bytes: ledger.remote_control_outbox_sealed_bytes,
        remote_replay_scope_count: ledger.remote_replay_scope_count,
        remote_replay_retired_scope_count: ledger.remote_replay_retired_scope_count,
        remote_replay_pin_count: ledger.remote_replay_pin_count,
        remote_replay_sealed_bytes: ledger.remote_replay_sealed_bytes,
        remote_counter_state_count: ledger.remote_counter_state_count,
        remote_counter_state_sealed_bytes: ledger.remote_counter_state_sealed_bytes,
        remote_counter_guard_manifest_count: ledger.remote_counter_guard_manifest_count,
        remote_key_transition_count: ledger.remote_key_transition_count,
        remote_key_transition_active_count: ledger.remote_key_transition_active_count,
        remote_key_transition_sealed_bytes: ledger.remote_key_transition_sealed_bytes,
        remote_key_update_outbox_count: ledger.remote_key_update_outbox_count,
        remote_key_update_outbox_sealed_bytes: ledger.remote_key_update_outbox_sealed_bytes,
