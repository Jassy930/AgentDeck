...
overall closeout，W2 automatic overall complete。W3.1 counter reservation 与 W3.2 replay/cursor
statePending 三个 deterministic crash cut 均已关闭；W3.3–W3.7 的第二 tab、browser kill、网络故障和三次
fresh run尚未开始。
