...
current codec、98-fixture 与真实 UDS Swift readback，A2 complete；shared-daemon client 默认入口 cutover 尚未完成。
...
history projection 与 P3.9-A/B Rust/Swift shared-daemon client component 也已分别完成 Task 门禁与双路终审；
下一项为 P3.9-C3 App model cutover。P3.1 的
provisioned signed Keychain 外部门禁仍有
1 项 ignored/BLOCKED，但不阻塞主线。P3.9-C3/D/E client cutover、P3.10、P4 E2EE/Relay Publish
