...
| Codex | 消息、reasoning、plan、shell、diff、tool 翻译 | 部分 | 常见 completed item 与 `functionCallOutput` 能映射到中立类型，未知 item 有受限 raw 降级；若干 progress、usage 和 vendor panel 信息未进入主干。 | `agentdeckd/src/codex/translate.rs` |
