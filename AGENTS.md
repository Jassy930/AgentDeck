...
7. `docs/plans/README.md` 与 `docs/plans/`：设计文档和实施计划规则。Relay 的产品边界继续以 `docs/plans/2026-07-10-relay-companion-mvp-design.md` 为准；从 2026-07-28 起，实施只允许从 `docs/plans/2026-07-28-relay-companion-mvp-rescue-implementation.md` 进入。旧 implementation 与 course-correction 只保留历史证据，不得继续据其未完成 P5.8–P6 扩展范围。
