...
/// Runtime v2 JSON/UDS actor client。所有 pending、reply/stream queue、transfer reassembly
    ...
    do {
      ...
      default:
        let failure = failure(
          ...
          "first correlated terminal is not Runtime v2 Hello"
        )
        failConnection(failure)
        throw failure
      }
      ...
      do {
        ...
        failConnection(
          failure(
            ...
            "Runtime v2 envelope decode failed: \(error)"
          )
        )
      }
    }
