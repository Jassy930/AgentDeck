...
/// Runtime v5 JSON/UDS actor client。所有 pending、reply/stream queue、transfer reassembly
    ...
    do {
      ...
      default:
        let failure = failure(
          ...
          "first correlated terminal is not Runtime v5 Hello"
        )
        failConnection(failure)
        throw failure
      }
      ...
      do {
        ...
        failConnection(
          failure(
            ...
            "Runtime v5 envelope decode failed: \(error)"
          )
        )
      }
    }
